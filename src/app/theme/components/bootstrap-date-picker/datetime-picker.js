...
// Version: 2.4.3
// Released: 2016-07-14
angular.module('arca.datetimepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
...
angular.module('arca.datetimepicker').run(['$templateCache', function($templateCache) {
  'use strict';
